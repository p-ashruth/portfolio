...
const Projects = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description:
        "Real-time chat application with AI-powered features and smart responses.",
      longDescription:
        "An innovative chat application that combines real-time messaging with AI capabilities. Features include intelligent message suggestions, sentiment analysis, language translation, smart notifications, file sharing, group chats, and AI-powered chatbots for customer support.",
      image:
                  ...
                  <div className="relative overflow-hidden rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-700 bg-gray-900">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-8 group-hover:translate-y-0 transition-all duration-500 delay-100">
                        ...
                        <p
                          className="text-gray-200 text-sm opacity-90 font-medium"
                          style={{
                            fontFamily:
                              "Inter, system-ui, -apple-system, sans-serif",
                          }}
