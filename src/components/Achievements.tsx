...
const Achievements = () => {
  ...
  const certifications = [
    ...
    },
    {
      ...
      description:
        "Complete MERN stack development with modern best practices and deployment",
      date: "2023",
      issuer: "freeCodeCamp",
      image:
    ...
    },
    {
      ...
      description:
        "Data Structures and Algorithms certification with JavaScript implementation",
      date: "2023",
      issuer: "freeCodeCamp",
      image:
    ...
    },
    {
      ...
      description:
        "Server-side development with Express.js, MongoDB, and RESTful APIs",
      date: "2023",
      issuer: "Coursera",
      image:
        "https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=400",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            ...
            >
              <div
                className="text-4xl font-bold text-white hover:text-black mb-2"
                style={{
