...
const PinterestLayout = () => {
  ...
  const socialLinks = [
    ...
    {
      icon: Linkedin,
      url: "https://www.linkedin.com/in/ashruth-pamidimarri-b96798314/",
      label: "LinkedIn",
    },
    {
      icon: Code,
      url: "https://leetcode.com/u/indefinite/",
      label: "LeetCode",
    },
  ...
  const filteredPins =
    activeSection === "home"
      ...
      : pins.filter(
          (pin) =>
            pin.type === activeSection ||
            (activeSection === "projects" && pin.type === "project") ||
